...
xgettext *.php */*.php --copyright-holder='Datainjection Development Team' --package-name='GLPI - Datainjection plugin' --package-version='2.2.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
