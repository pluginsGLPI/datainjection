...
$LANG["datainjection"]["modelStep"][1] = "Сбор информации о файле";
$LANG["datainjection"]["modelStep"][2] = "Редактирование модели";
$LANG["datainjection"]["modelStep"][3] = "Выберите тип файла для импорта.";
$LANG["datainjection"]["modelStep"][4] = "Тип импортируемых данных :";
$LANG["datainjection"]["modelStep"][5] = "Тип файла :";
$LANG["datainjection"]["modelStep"][6] = "Создавать новые записи :";
$LANG["datainjection"]["modelStep"][7] = "Обновлять существующие записи :";
$LANG["datainjection"]["modelStep"][8] = "Создавать списки :";
$LANG["datainjection"]["modelStep"][9] = "Название колонок в 1й строке :";
$LANG["datainjection"]["modelStep"][10] = "Разделитель :";
$LANG["datainjection"]["modelStep"][11] = "Заполните поле «Разделитель»!";
$LANG["datainjection"]["modelStep"][12] = "Обновлять существующие записи :";
$LANG["datainjection"]["modelStep"][13] = "Основная информация";
$LANG["datainjection"]["modelStep"][14] = "Настройки ";
$LANG["datainjection"]["modelStep"][15] = "Дополнительные настройки";
$LANG["datainjection"]["modelStep"][16] = "Diffusion :";
$LANG["datainjection"]["modelStep"][17] = "Public";
$LANG["datainjection"]["modelStep"][18] = "Private";
$LANG["datainjection"]["modelStep"][19] = "Дополнительные настройки предоставляют улучшенный контроль процесса импорта. Редактировать их должны только опытные пользователи.";
$LANG["datainjection"]["modelStep"][20] = "Пытаться заполнять сетевые соединения";
$LANG["datainjection"]["modelStep"][21] = "Формат дат";
...
$LANG["datainjection"]["infoStep"][1] = "Дополнительные сведения";
$LANG["datainjection"]["infoStep"][2] = "Изменение дополнительной информации";
$LANG["datainjection"]["infoStep"][3] = "Этот шаг позволяет заполнить поля не указанные в импортируемом файле. Данные будут запрошены при использовании модели.";
$LANG["datainjection"]["infoStep"][4] = "Данные будут присвоены всем импортируемым объектам.";
$LANG["datainjection"]["infoStep"][5] = "Обязательная информация";
