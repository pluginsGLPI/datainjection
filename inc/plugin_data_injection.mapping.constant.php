...
define ("NETPLUG_TYPE",997);
define ("NETPORT_TYPE",999);

global $LANG,$DATA_INJECTION_MAPPING,$IMPORT_TYPES,$IMPORT_PRIMARY_TYPES,$DATAINJECTIONLANG,$IMPORT_NETFIELDS,$PLUGIN_HOOKS,$CONNECT_TO_COMPUTER_TYPES;
...
$IMPORT_PRIMARY_TYPES = array(COMPUTER_TYPE, MONITOR_TYPE, PRINTER_TYPE, PHONE_TYPE, USER_TYPE, NETWORKING_TYPE, GROUP_TYPE, CONTRACT_TYPE, PERIPHERAL_TYPE, ENTERPRISE_TYPE, CONTACT_TYPE, CARTRIDGE_TYPE, CONSUMABLE_TYPE,ENTITY_TYPE);
$MANDATORY_MAPPINGS = array(SOFTWARE_TYPE=>array("manufacturer"));

//Types to be connected to a computer
$CONNECT_TO_COMPUTER_TYPES = array(PERIPHERAL_TYPE,MONITOR_TYPE,PRINTER_TYPE,PHONE_TYPE);
