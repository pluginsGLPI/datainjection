...
if(isset($_POST['id']))
	...
	echo "<tr>";
	echo "<td><input type='hidden' id='add$key' value='0'></td><td>$key</td><td><select name='field[$key][0]' id='table$key' onchange='go_info($key);addelete_info($key)' style='width: 150px'>";
