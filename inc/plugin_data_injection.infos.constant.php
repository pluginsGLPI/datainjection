...
$DATA_INJECTION_INFOS[INFOCOM_TYPE]['domain']['name']=$LANG["common"][15];
$DATA_INJECTION_INFOS[INFOCOM_TYPE]['domain']['linkfield']='domain';
$DATA_INJECTION_INFOS[INFOCOM_TYPE]['domain']['type']='dropdown';
