 ...
 * We need to add specific datainjection types because devices are managed as DEVICE_TYPE + specific subtype for each device type...
 */
function loadDeviceSpecificTypes() {
	...
	{
				registerPluginType('datainjection', $name, $infos["ID"], array(
...
/**
 * Return device subtype for a device type defined in datainjection
 * @param type the datainjection device type
