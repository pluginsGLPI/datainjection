...
{	
	...
	if (document.getElementById('create').checked)
		...
		xhr.open("POST","../inc/plugin_datainjection.ajax.selectmodel.php",true);
...
{	
	...
	xhr.open("POST","../inc/plugin_datainjection.ajax.backend.php",true);
...
{	
	...
	if(add==0)
		...
		xhr.open("POST","../inc/plugin_datainjection.ajax.selectfield.php",true);
